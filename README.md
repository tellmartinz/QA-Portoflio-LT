...
### 1. ✅ [Defect / Bug Reports](./02-Bug-Reports/)
18 bug reports found while testing **ForkMesh**, a decentralized alternative to GitHub — covering its 3D interactive environment, Windows desktop client, and web app. Organized by severity in the [Bug Reports Index](./02-Bug-Reports/README.md).

### 2. ✅ [Feature Requests](./03-Feature-Requests/)
3 process/UX improvement proposals submitted based on gaps identified during testing — see the [Feature Requests Index](./03-Feature-Requests/README.md).

### 3. 🚧 API Testing & Protocol Analysis - ForkMesh *(Coming soon)*
...
### 4. 🚧 Test Design & Execution *(Coming soon)*
